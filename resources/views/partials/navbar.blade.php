<nav class="navbar navbar-expand-lg navbar-light bg-white shadow-sm sticky-top">
    <div class="container">
        ...
        <div class="me-3 dropdown">
            <a class="nav-link dropdown-toggle text-info fw-bold" href="#" role="button" data-bs-toggle="dropdown">
    ...
    <img src="{{ asset('storage/products/BOOKS.png') }}" alt="HT Store Logo" 
         style="height: 65px; width: auto; margin-top: -15px; margin-bottom: -10px;">
</a>
